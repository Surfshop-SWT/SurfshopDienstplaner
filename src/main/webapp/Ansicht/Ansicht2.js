...
function createTable(month, year) {
    ...
    for (let i = 0; i < 4; i++) {
        ...
        dataHtml += `<tr><th class="date">KW ${week}</th>
                    <th class="day day-word">
                        Montag
                        <ul class="day-menu">
                            <li><input class="knopf" type="submit" value="Kommentar setzen"></li>
                            <li><input class="knopf" type="submit" value="Anfrage auf freien Tag"></li>
                            <li><input class="knopf" type="submit" value="Anfrage auf Urlaub"></li>
                        </ul>
                    </th>
                        <th class="day day-word">
                        Dienstag
